...
本文档维护者的个人配置和业务上下文信息存储在Codex的记忆系统中，供AI代理参考。

**配置文件位置**: `~/.Codex/projects/-Users-zhoulittlezhou/memory/user_profile.md`
