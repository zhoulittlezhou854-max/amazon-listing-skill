...
def test_header_body_rupture_surface_through_coherence_check():
    bullets = [
        "LIGHTWEIGHT DESIGN — It weighs only 35g and suits daily commutes.",
        "CRISP VIDEO — 1080P footage stays easy to review.",
    ]

    issues = cc.check_coherence("1080P body camera", bullets, "")

    assert any(issue.issue_type == "header_body_rupture" for issue in issues)
