...
class AmazonListingGenerator:
    ...
    def run_step_5(self) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                blueprint = blueprint_generator.generate_bullet_blueprint(
                ...
                print(f"  Bullet Blueprint 已生成: {bullet_count} 槽位")
...
def run_generator_workflow(config_path: str, output_dir: str, steps: Optional[List[int]] = None) -> Dict[str, Any]:
    """Programmatic entrypoint used by Streamlit/service layer."""
    generator = AmazonListingGenerator(config_path, output_dir)
